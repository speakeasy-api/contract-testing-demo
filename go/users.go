...
func (s *Users) Create(ctx context.Context, request components.User, opts ...operations.Option) (*operations.CreateUserResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/anything/user")
	if err != nil {
...
func (s *Users) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetUserResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/anything/user/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
// Update User
func (s *Users) Update(ctx context.Context, id string, user components.User, opts ...operations.Option) (*operations.UpdateUserResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
